document.addEventListener('DOMContentLoaded', function() {
    ...
    const dishes = [
        ...
        // PESCADOS
        { id: 70, name: "À Dorê", price: "R$ 119,00 (Pescada) | R$ 149,00 (Linguado)", description: "Acompanha arroz branco e batata sauté.", category: "pescados", image: PLACEHOLDER_IMAGE, disponivel: true, destaque: false, ordem: 1 },
        { id: 71, name: "À Milanesa", price: "R$ 125,00 (Pescada) | R$ 155,00 (Linguado)", description: "Acompanha arroz à grega e batata frita.", category: "pescados", image: PLACEHOLDER_IMAGE, disponivel: true, destaque: false, ordem: 2 },
        { id: 72, name: "Ao Molho de Camarão", price: "R$ 150,00 (Pescada) | R$ 180,00 (Linguado)", description: "À dorê, coberto com molho de camarão, acompanha arroz branco e pirão.", category: "pescados", image: PLACEHOLDER_IMAGE, disponivel: true, destaque: false, ordem: 3 },
        { id: 73, name: "À Parmegiana", price: "R$ 149,00 (Pescada) | R$ 179,00 (Linguado)", description: "À milanesa, gratinado com mussarela, molho sugo e parmesão, acompanha arroz branco e batata frita.", category: "pescados", image: PLACEHOLDER_IMAGE, disponivel: true, destaque: false, ordem: 4 },
        { id: 74, name: "À Dorê/Milanesa com Salada", price: "R$ 98,00 (Pescada) | R$ 128,00 (Linguado)", description: "Acompanha alface, tomate, cebola, pepino, palmito e arroz branco.", category: "pescados", image: PLACEHOLDER_IMAGE, disponivel: true, destaque: false, ordem: 5 },
